...
class Base64BinaryValueFactoryTest extends AbstractAttributeValueFactoryTest {

  public static final String TESTED_ATTRIBUTE_TYPE = Base64BinaryAttributeValue.SERIALIZATION_TYPE;
  public static final Class TESTED_ATTRIBUTE_CLASS = Base64BinaryAttributeValue.class;
  ...
  void itCanCreateAttribute() {
    this.testItCanCorrectlyCreateAttributeOfVariousDataStructureType(
        ...
        List.of("ExampleValue1", "ExampleValue2", "ExampleValue3")
    );
  }
